...
export default class AddGroveGamingDetails extends Component {
  ...
  componentDidMount() {
    console.log(this.props.navigation.state.params.groveGamingDetails);
    this.assignStateValues();
  }
  assignStateValues = () => {
    this.setState({
      treeId: this.props.navigation.state.params.groveGamingDetails.treeid,
      LandType: this.props.navigation.state.params.groveGamingDetails.LandType,
      SoilType: this.props.navigation.state.params.groveGamingDetails.SoilType,
      SurveyPlotNo: this.props.navigation.state.params.groveGamingDetails
        .SurveyPLotNo,
      LandDetails: this.props.navigation.state.params.groveGamingDetails
        .LandDetails,
    });
  };
  GroveGamingFunction = () => {
    ...
    fetch('https://krishhortus.com/app/update_grove_gaming.php', {
      method: 'POST',
      headers: {
